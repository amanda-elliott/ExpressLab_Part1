...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addNewItem = function (newItem) {
        var _this = this;
        this.cartService.addItem(newItem).subscribe(function (response) {
            _this.items = response;
        });
    };
    ...
    AppComponent.prototype.updateItem = function (id, newItem) {
        var _this = this;
        this.cartService.updateItem(id, newItem).subscribe(function (response) {
            _this.items = response;
        });
    };
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.updateItem = function (id, newItem) {
...
module.exports = __webpack_require__(/*! C:\Users\Amanda\documents\grand_circus\labs\express-lab\src\main.ts */"./src/main.ts");
